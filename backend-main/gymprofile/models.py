...
class GymProfile(BaseModel):
    ...
    fitness_type=models.CharField(choices=FITNESS_CHOICE,max_length=255, default='yoga')
...
class Transaction(BaseModel):
    ...
    transaction_amount = models.FloatField(max_length=12,null=True,blank=True)
...
class ChooseAmmenties(BaseModel):
    gym = models.ForeignKey('GymProfile',on_delete=models.CASCADE,null=True,blank=True)
    ammenties_name=models.ManyToManyField('Ammenities',blank=True)
