...
class GymGalleryList(serializers.ModelSerializer):
        class Meta:
                model= GymProfile
                fields =['uuid','gym_image']
...
class ChooseAmmentiesSerializer(serializers.ModelSerializer):
        
        ammenties_name= serializers.StringRelatedField(many=True)
        class Meta:
                model=ChooseAmmenties
                fields='__all__'  
