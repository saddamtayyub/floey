...
urlpatterns = [
    ...
    path('gymgallery/',GymGallery.as_view(), name='gymGallery'),
    ...
    path('totalrevenue/',TotalRevenue.as_view(),name = 'trevenue'),
    path('classrevenue/',ClassRevenue.as_view(),name = 'clrevenue'),
    path('courserevenue/',CourseRevenue.as_view(),name = 'crrue'),
    path('activeplan/<str:id>/',ActivePackage.as_view(),name = 'crrnue'),
    path('expplan/<str:id>/',ExpPackage.as_view(),name = 'crrnue'),

    path('chooseammenities/',ChooseAmmenities.as_view())
