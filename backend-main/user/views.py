    ...
    def post(self,request):
        ...
        if UserClass.objects.filter(select_user=data.get('user_uuid'),gym = data.get('gym_id')).exists():
            ...
            if class_passes >= 0:
                ...
                if UserClass.objects.filter(select_classes = data.get('class_uuid'),booked_date = booked_date,select_user=data.get('user_uuid'),gym = data.get('gym_id')).exists():
                    ...
                    if query.seat_available:
                        ...
                        classes.seat_available = int(classes.seat_available)-1
                        classes.save()
                    else:
