# Generated by Django 3.2 on 2021-12-03 10:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='History', max_length=255)),
                ('for_date', models.DateField(blank=True, null=True)),
                ('package_class_passes', models.IntegerField()),
                ('history_image', models.FileField(blank=True, null=True, upload_to='userhistory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_passes', models.IntegerField(blank=True, null=True)),
                ('class_instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gymprofile.instructor')),
                ('gym', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gymprofile.gymprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passes', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='base.basemodel')),
                ('admin_permissions', models.TextField(blank=True, null=True)),
