...
class Subscription(BaseModel):
    ...
    passes =models.IntegerField(default=0,null=True,blank=True)
...
class UserHistory(BaseModel):
    ...
    package_class_passes = models.IntegerField()
...
class UserClass(BaseModel):
    ...
    class_passes = models.IntegerField(null=True,blank=True)
